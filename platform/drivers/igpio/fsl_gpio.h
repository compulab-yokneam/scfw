...
/*!
 * @brief Reads the current GPIO pin pad status.
 * @deprecated Do not use this function.  It has been superseded by @ref GPIO_PinReadPadStatus.
 */
...
/*!
 * @brief Sets the current pin interrupt mode.
 * @deprecated Do not use this function.  It has been superseded by @ref GPIO_PinSetInterruptConfig.
 */
...
/*!
 * @brief Disables the specific pin interrupt.
 * @deprecated Do not use this function.  It has been superseded by @ref GPIO_PortDisableInterrupts.
 */
