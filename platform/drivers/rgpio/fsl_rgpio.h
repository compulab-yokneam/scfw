...
/*!
 * @brief Sets the output level of the multiple RGPIO pins to the logic 1 or 0.
 * @deprecated Do not use this function.  It has been superseded by @ref RGPIO_PinWrite.
 */
...
/*!
 * @brief Sets the output level of the multiple RGPIO pins to the logic 1.
 * @deprecated Do not use this function.  It has been superseded by @ref RGPIO_PortSet.
 */
...
/*!
 * @brief Sets the output level of the multiple RGPIO pins to the logic 0.
 * @deprecated Do not use this function.  It has been superseded by @ref RGPIO_PortClear.
 *
 * @param base RGPIO peripheral base pointer (RGPIOA, RGPIOB, RGPIOC, and so on.)
 * @param mask RGPIO pin number macro
 */
...
/*!
 * @brief Reverses the current output logic of the multiple RGPIO pins.
 * @deprecated Do not use this function.  It has been superseded by @ref RGPIO_PortToggle.
 */
...
/*!
 * @brief Reads the current input value of the RGPIO port.
 * @deprecated Do not use this function.  It has been superseded by @ref RGPIO_PinRead.
 */
...
/*!
 * @brief Reads the RGPIO port interrupt status flag.
 * @deprecated Do not use this function.  It has been superseded by @ref RGPIO_PortGetInterruptFlags.
 */
...
/*!
 * @brief Clears multiple RGPIO pin interrupt status flags.
 * @deprecated Do not use this function.  It has been superseded by @ref RGPIO_PortClearInterruptFlags.
 */
...
/*!
 * @brief Initializes the FGPIO peripheral.
 * @deprecated Do not use this function.  It has been superseded by @ref FGPIO_PortInit.
 */
...
/*!
 * @brief Sets the output level of the multiple FGPIO pins to the logic 1 or 0.
 * @deprecated Do not use this function.  It has been superseded by @ref FGPIO_PinWrite.
 */
...
/*!
 * @brief Sets the output level of the multiple FGPIO pins to the logic 1.
 * @deprecated Do not use this function.  It has been superseded by @ref FGPIO_PortSet.
 */
...
/*!
 * @brief Sets the output level of the multiple FGPIO pins to the logic 0.
 * @deprecated Do not use this function.  It has been superseded by @ref FGPIO_PortClear.
 */
...
/*!
 * @brief Reverses the current output logic of the multiple FGPIO pins.
 * @deprecated Do not use this function.  It has been superseded by @ref FGPIO_PortToggle.
 */
...
/*!
 * @brief Reads the current input value of the FGPIO port.
 * @deprecated Do not use this function.  It has been superseded by @ref FGPIO_PinRead
 */
...
/*!
 * @brief Reads the FGPIO port interrupt status flag.
 * @deprecated Do not use this function.  It has been superseded by @ref FGPIO_PortGetInterruptFlags.
 */
...
/*!
 * @brief Clears the multiple FGPIO pin interrupt status flag.
 * @deprecated Do not use this function.  It has been superseded by @ref FGPIO_PortClearInterruptFlags.
 */
